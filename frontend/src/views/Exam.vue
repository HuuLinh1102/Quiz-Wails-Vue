  ...
  <div>
    <div>
      ...
      <Question v-for="(question, index) in questions" 
                ...
                @update-selected-answer="updateSelectedAnswer(index, $event)"/>
...
export default {
  ...
  methods: {
    ...
    updateSelectedAnswer(index, selectedAnswer) {
      const answerLabel = selectedAnswer.charAt(0);
      this.selectedAnswers[index] = answerLabel;
      console.log('Câu trả lời:', this.selectedAnswers[index]);
    },
    completeExam() {
      this.$swal.fire({
