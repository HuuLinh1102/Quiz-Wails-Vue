  ...
  <div>
    <div>
      ...
      <Question v-for="(question, index) in questions" 
                ...
                @answer-selected="updatSelectedAnswer(index, $event)"/>
...
import { LoadQuestions, CheckAnswers } from '../../wailsjs/go/main/App';
...
export default {
  ...
  methods: {
    ...
    updateSelectedAnswer(index, selectedAnswer) {
      // this.examQuestions[index] = reactive({
      //   ...this.examQuestions[index],
      //   selectedAnswer: choice
      // });
      this.$set(this.selectedAnswers, index, selectedAnswer);
    },
    completeExam() {
      this.$swal.fire({
    ...
    calculateScore() {
      let score = 0;
      // const correctAnswers = this.questions.filter(questions => questions.answer === questions.selectedAnswer);
      ...
      let correctAnswers = (score / this.questions.length) * 10;
